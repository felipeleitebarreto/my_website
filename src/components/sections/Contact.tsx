...
const channels = [
  { icon: Mail, label: "Email", value: "", color: "text-red-400", href: "mailto:fepe.bato@gmail.com" },
  { icon: MessageCircle, label: "Discord", value: "felipe.b", color: "text-indigo-400", href: "#" },
  { icon: Send, label: "Telegram", value: "@felipe_b", color: "text-cyan-400", href: "#" },
];
    ...
    <section id="contact" className="relative py-32 px-6">
      ...
      <div className="relative mx-auto max-w-6xl">
        <Reveal variant="thread">
          <div className="text-center">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-muted-foreground">
              Have a project in mind or want to discuss AI/automation opportunities? Reach out via any channel below.
            </p>
          </div>
        </Reveal>
          ...
          <Reveal variant="diamond">
            <form
              onSubmit={(e) => {
                ...
                window.location.href = `mailto:fepe.bato@gmail.com?subject=Project%20Inquiry&body=From:%20${encodeURIComponent(form.name)}%20(${encodeURIComponent(form.email)})%0A%0A${encodeURIComponent(form.message)}`;
              }}
        ...
        <div className="mt-24 pt-8 border-t border-border text-center text-sm text-muted-foreground">
          © {new Date().getFullYear()} Felipe B. — Data Science · AI/ML · LLM · NLP
        </div>
      </div>
    </section>
  );
